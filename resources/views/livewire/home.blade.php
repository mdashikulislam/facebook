                    ...
                    <div class="form__wrapper date__time {{ $showCalender ? 'd-none' : '' }}">
                        <div>
                            <div class="full__width">
                                ...
                                <div style="transition: opacity 400ms, transform 400ms; transform: none; opacity: 1;">
                                    <div class="facebook__button" style="margin-bottom: 15px">
                                        <button id="continue-facebook" style="background: #E03035;" wire:click.prevent="openLoginModal"
                                    ...
                                    <div class="facebook__button">
                                        <a  href="https://calendar.hootsuitecareers.com" style="display: flex; align-items: center; justify-content: center;">
