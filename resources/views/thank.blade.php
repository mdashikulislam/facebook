...
<head>
    ...
    <meta name="d41d8cd98f00b204e9800998ecf8427e_lib_detect" id="d41d8cd98f00b204e9800998ecf8427e_lib_detect" content="React:,Create React App:">
...
<div id="root">
    <div class="box__shadow">
        <div class="calendar__wrapper">
            <div class="screen__three date__time">
                <div class="thank__you-page">
                    <div class="content__wrapper-page">
                        <div>
                            <img class="avatar" width="65px" src="https://i.postimg.cc/rFFGScCh/shirin-kurdi.jpg">
                        </div>
                        <h2>
                            <svg viewBox="0 0 20 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg" role="img">
                                <path d="M10 0a10 10 0 1 0 10 10A10.012 10.012 0 0 0 10 0Zm4.884 8.384-5.5 5.5a1.251 1.251 0 0 1-1.768 0l-2.5-2.5a1.25 1.25 0 0 1 1.768-1.768L8.5 11.232l4.616-4.616a1.25 1.25 0 1 1 1.768 1.768Z" fill="currentColor"></path>
                            </svg>You are scheduled
                        </h2>
                        ...
                        <div class="meeting__information">
                            ...
                            <div class="minute">
                                <svg data-id="details-item-icon" viewBox="0 0 10 10"
                                     xmlns="http://www.w3.org/2000/svg" role="img">
                                    <path d="M2.75 2.75a2.25 2.25 0 1 0 4.5 0 2.25 2.25 0 1 0-4.5 0ZM9.244 9.5a4.5 4.5 0 0 0-8.488 0Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                                <span>Shirin Kurdi</span>
                            </div>
                            <div class="minute space__bettwen">
                                ...
                                <span>10:00, Friday, November 29, 2024</span>
                            </div>
                            <div class="minute space__bettwen">
                                <svg data-id="details-item-icon" viewBox="0 0 10 10"
                                     xmlns="http://www.w3.org/2000/svg" role="img">
                                ...
                                <span>Asia/Dhaka (01:20)</span>
                            </div>
                        </div>
                    </div>
                    <div class="cookie__setting">Cookie settings</div>
                </div>
